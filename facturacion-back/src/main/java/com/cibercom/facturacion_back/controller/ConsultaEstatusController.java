...
public class ConsultaEstatusController {
    ...
    /**
     * Endpoint para consultar el estatus de una factura
     */
    @PostMapping("/estatus")
    ...
    /**
     * Endpoint para consultar el estatus de una factura usando XML directamente
    ...
    public ResponseEntity<String> consultarEstatusXml(@RequestBody String xmlRequest) {
        ...
        try {
            ...
            if (uuid == null || uuid.isEmpty()) {
                // Intentar con el prefijo liv: si no se encontró sin prefijo
            ...
            if (factura != null) {
                ...
                // Determinar el estado y estatus de cancelación para el XML
                String estadoXml = estado;
                String estatusCancelacion = "";
    ...
    /**
     * Determina si una factura es cancelable basado en su estado actual
     */
    ...
    /**
     * Extrae un valor de un XML usando etiquetas de inicio y fin
     */
    ...
    /**
     * Genera una respuesta XML exitosa
     */
    private String generarXmlRespuesta(String esCancelable, String codigoEstatus, String estado, String estatusCancelacion) {
        return "<?xml version='1.0' encoding='UTF-8'?>\n" +
               "<senv:Envelope xmlns:senv=\"http://schemas.xmlsoap.org/soap/envelope/\" " +
               "xmlns:s0=\"apps.services.soap.core.views\">\n" +
               "    <senv:Body>\n" +
