...
public class ConsultaEstatusService {
    ...
    public ConsultaEstatusResponse consultarEstatus(ConsultaEstatusRequest request) {
        try {
            // Construir el XML SOAP para la solicitud
    ...
    private ConsultaEstatusResponse procesarRespuesta(String xmlResponse) {
        try {
            // Extraer los valores relevantes del XML
            // Nota: En un entorno real, deberías usar un parser XML adecuado
            ...
            String estatusCancelacion = extraerValor(xmlResponse, "<s0:EstatusCancelacion>", "</s0:EstatusCancelacion>");
